...
pub fn api_router_v1(keys: JwtKeys) -> OpenApiRouter<AppState> {
    OpenApiRouter::new()
        ...
        .route("/jobs/stream", axum::routing::get(jobs_stream))
        ...
        .route("/workers/stream", axum::routing::get(workers_stream))
        ...
        .routes(routes!(create_db_config))
        .routes(routes!(list_db_configs))
